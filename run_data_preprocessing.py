...
import os, sys
path_list = sys.path
module_path = '/Users/hanguo/Documents/Codes/Data_Processing'
...
from utils.distribution_analysis import analyze_assay, value_distribution
from utils.util import sdf_to_csv, json_to_csv, combine_files, split_file, add_SMILES, get_subset
...
def run_cleanup_duplicates(input_file):
    ...
    deduplication_method = 'mean'
    remove_duplicates(input_file, by_column, deduplication_method,
...
def run_util(input_file, task = ''):
    ...
    # Add SMILES
        ...
        add_SMILES(input_file, id_column_name_query=id_column_name_query, input_file_SMILES=input_file_SMILES)
