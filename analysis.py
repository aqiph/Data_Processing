...
def analyze_assay(input_file, assay_column_name, value_column_name):
    ...
    :para assay_column_name: str, name of assay column to be analyzed
    :para value_column_name: str, name of value column to be analyzed
    """
...
def value_distribution(input_file, value_column_name, useLog = False, range = [0, 10]):
    ...
    :para input_file: str, the filename of the input file
    :para value_column_name: str, name of value column to be analyzed
    :para useLog: bool, whether to use log or raw value
    :para range: list of two ints, range of the plot
    """
    # output file path without extension
    output_file, fmt = os.path.splitext(os.path.abspath(input_file))
